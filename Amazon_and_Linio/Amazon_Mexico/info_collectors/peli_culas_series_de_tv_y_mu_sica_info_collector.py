...
from product_parsers.peli_culas_series_de_tv_y_mu_sica_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Peli_culas_Series_de_TV_y_Mu_sica_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
