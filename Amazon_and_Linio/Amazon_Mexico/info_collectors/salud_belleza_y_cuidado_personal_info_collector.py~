...
from product_parsers.salud_belleza_y_cuidado_personal_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Salud_Belleza_y_Cuidado_Personal_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
