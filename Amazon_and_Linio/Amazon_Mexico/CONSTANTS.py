...
DOMAIN_NAME = 'https://www.amazon.com.mx'

PROJECT_DOMAIN = 'www.amazon.com.mx'

MARKET_PLACE_NAME = 'AMAZON_MEX'
...
DEBUG_ON = "ON"
# to compare with DataCollectors_Configuration.write_to value
WRITE_TO_DB = 1
...
# to compare with DataCollectors_Configuration.url_flag value
URL_FLAG = 1

#to compare with DataCollectors_Configuration.info_flag value
PRODUCT_FlAG = 1

# category_names
AUTOMOTRIZ_Y_MOTOCICLETAS = 'Automotriz_y_Motocicletas'
BEBE_ = 'Bebe_'
CO_MPUTO_Y_TABLETS = 'Co_mputo_y_Tablets'
DEPORTES_Y_AIRE_LIBRE = 'Deportes_y_Aire_Libre'
ELECTRO_NICOS = 'Electro_nicos'
HANDMADE = 'Handmade'
HERRAMIENTAS_Y_MEJORAS_DEL_HOGAR = 'Herramientas_y_Mejoras_del_Hogar'
HOGAR_Y_COCINA = 'Hogar_y_Cocina'
INDUSTRIA_EMPRESAS_Y_CIENCIA = 'Industria_Empresas_y_Ciencia'
JUEGOS_Y_JUGUETES = 'Juegos_y_Juguetes'
LIBROS = 'Libros'
MASCOTAS_Y_ACCESORIOS = 'Mascotas_y_Accesorios'
PELI_CULAS_SERIES_DE_TV_Y_MU_SICA = 'Peli_culas_Series_de_TV_y_Mu_sica'
ROPA_ZAPATOS_Y_ACCESORIOS = 'Ropa_Zapatos_y_Accesorios'
SALUD_BELLEZA_Y_CUIDADO_PERSONAL = 'Salud_Belleza_y_Cuidado_Personal'
SOFTWARE = 'Software'
