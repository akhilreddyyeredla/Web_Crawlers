...
def create_directory_and_hierarchy_files(hiearchy, line):
    ...
    path = '{}{}{}{}{}'.format(DataCollectors_Configuration.ROOT_FOLDER, DataCollectors_Configuration.PATH_STYLE, DataCollectors_Configuration.PROJECT_NAME, DataCollectors_Configuration.PATH_STYLE,
...
def update_files(hierarchy_name, urls_list, page_url, queue_file_name, completed_file_name):
    queue_path = '{}{}{}{}{}{}{}'.format(DataCollectors_Configuration.ROOT_FOLDER, DataCollectors_Configuration.PATH_STYLE, DataCollectors_Configuration.PROJECT_NAME,
    ...
    completed_path = '{}{}{}{}{}{}{}'.format(DataCollectors_Configuration.ROOT_FOLDER, DataCollectors_Configuration.PATH_STYLE,
                                             DataCollectors_Configuration.PROJECT_NAME,
                                             DataCollectors_Configuration.PATH_STYLE,
                                             hierarchy_name.replace('|', DataCollectors_Configuration.PATH_STYLE),
