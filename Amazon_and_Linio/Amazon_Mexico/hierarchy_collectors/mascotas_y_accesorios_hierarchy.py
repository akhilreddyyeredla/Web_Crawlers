...
def start_program():
    links = [
        'Mascotas_y_Accesorios|Todo_en_Mascotas_y_Accesorios|https://www.amazon.com.mx/mascotas/b/ref=sd_allcat_all_pets/144-5122508-0436835?ie=UTF8&node=11782336011'
    ]
    for link in links:
