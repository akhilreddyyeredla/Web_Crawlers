...
def start_program():
    links = [
        'Juegos_y_Juguetes|Todo_en_Juegos_y_Juguetes|https://www.amazon.com.mx/juegos-y-juguetes/b/ref=sd_allcat_all_toys_games/144-5122508-0436835?ie=UTF8&node=11260442011'
    ]
    for link in links:
