...
def start_program():
    links = [
        'Herramientas_y_Mejoras_del_Hogar|Todo_en_Herramientas_y_Mejoras_del_Hogar|https://www.amazon.com.mx/hogar-y-bricolaje/b/ref=sd_allcat_all_home_tools/144-5122508-0436835?ie=UTF8&node=9482670011'
    ]
    for link in links:
