...
def create_workers():
    """
    Creates threadpool and with max number of threads mentioned in DataCollectors_Configuration file and targets work fucntion
    :return: none
    """
...
def start_program():
    links = [
        'Salud_Belleza_y_Cuidado_Personal|Todo_en_Salud_Belleza_y_Cuidado_Personal|https://www.amazon.com.mx/salud-y-cuidado-personal/b/ref=sd_allcat_allhealth/144-5122508-0436835?ie=UTF8&node=9482610011'
    ]
    for link in links:
