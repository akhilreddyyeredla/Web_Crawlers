...
def start_program():
    links = [
        'Co_mputo_y_Tablets|Todo_en_Co_mputo_y_Tabletas|https://www.amazon.com.mx/b/ref=sd_allcat_all_computer_tablets/144-5122508-0436835?ie=UTF8&node=9687880011'
    ]
    for link in links:
