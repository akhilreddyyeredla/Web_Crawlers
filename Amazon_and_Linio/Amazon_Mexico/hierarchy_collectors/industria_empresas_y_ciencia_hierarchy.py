...
def start_program():
    links = [
        'Industria_Empresas_y_Ciencia|Todo_en_Industria_Empresas_y_Ciencia|https://www.amazon.com.mx/industrial-scientific/b/ref=sd_allcat_all_industrial/144-5122508-0436835?ie=UTF8&node=11076223011'
    ]
    for link in links:
