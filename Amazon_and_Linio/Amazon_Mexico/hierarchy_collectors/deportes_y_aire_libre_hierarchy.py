...
def start_program():
    links = [
        'Deportes_y_Aire_Libre|Todo_en_Deportes_y_Aire_Libre|https://www.amazon.com.mx/deportes-y-aire-libre/b/ref=sd_allcat_allsports/144-5122508-0436835?ie=UTF8&node=9482660011'
    ]
    for link in links:
