...
def start_program():
    links = [
        'Automotriz_y_Motocicletas|Todo_en_Automotriz_y_Motocicletas|https://www.amazon.com.mx/STRING-AUTOMOTIVE/b/ref=sd_allcat_nav_all_auto/144-5122508-0436835?ie=UTF8&node=13848848011'
    ]
    for link in links:
