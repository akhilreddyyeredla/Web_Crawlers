...
def get_product_urls(hierarchy_url):
    ...
    urls_list = []
    completed_path = '{}{}{}{}{}{}{}'.format(DataCollectors_Configuration.ROOT_FOLDER, DataCollectors_Configuration.PATH_STYLE, DataCollectors_Configuration.AMAZON_AUS_PROJECT_NAME,
...
def start_url_collection(folder_name):
    ...
    :return: None
    """
    path = '{}{}{}{}{}'.format(DataCollectors_Configuration.ROOT_FOLDER, DataCollectors_Configuration.PATH_STYLE, DataCollectors_Configuration.AMAZON_AUS_PROJECT_NAME, DataCollectors_Configuration.PATH_STYLE,
                               folder_name)
...
def start_program(folder_name):
    ...
    print 'Electronics_Computers_and_Office_url_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
