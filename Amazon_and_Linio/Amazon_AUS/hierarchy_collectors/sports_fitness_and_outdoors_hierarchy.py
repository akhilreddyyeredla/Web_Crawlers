...
def start_program():
    links = [
            'Sports_Fitness_and_Outdoors|All_Sports_Fitness_and_Outdoors|https://www.amazon.com.au/b/ref=sd_allcat_spt_all/356-7412848-8155927?ie=UTF8&node=4852559051'
            ]
    for link in links:
