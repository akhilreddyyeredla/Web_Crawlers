import os
import CONSTANTS
from DataCollectors_Configuration import *
...
def create_directory_and_hierarchy_files(hiearchy, line):
    ...
    path = '{}{}{}{}{}'.format(ROOT_FOLDER, PATH_STYLE, AMAZON_AUS_PROJECT_NAME, PATH_STYLE,
                               hiearchy.replace('|', PATH_STYLE))
...
def update_files(hierarchy_name, urls_list, page_url, queue_file_name, completed_file_name):
    queue_path = '{}{}{}{}{}{}{}'.format(ROOT_FOLDER, PATH_STYLE, AMAZON_AUS_PROJECT_NAME,
                                         PATH_STYLE,
                                         hierarchy_name.replace('|', PATH_STYLE),
                                         PATH_STYLE, queue_file_name)
    list_to_file(queue_path, urls_list)
    completed_path = '{}{}{}{}{}{}{}'.format(ROOT_FOLDER, PATH_STYLE,
                                             AMAZON_AUS_PROJECT_NAME,
                                             PATH_STYLE,
                                             hierarchy_name.replace('|', PATH_STYLE),
                                             PATH_STYLE, completed_file_name)
