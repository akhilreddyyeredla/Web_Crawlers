...
from product_parsers.home_and_kitchen_get_product_info import *
...
def start_info_collection(folder_name):
    ...
    print 'Home_and_Kitchen_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
