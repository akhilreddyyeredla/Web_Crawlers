...
from product_parsers.home_improvement_get_product_info import *
...
def start_info_collection(folder_name):
    ...
    print 'Home_Improvement_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
