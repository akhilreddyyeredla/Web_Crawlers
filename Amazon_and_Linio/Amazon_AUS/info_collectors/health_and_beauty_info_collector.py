...
from product_parsers.health_and_beauty_get_product_info import *
...
def start_info_collection(folder_name):
    ...
    print 'Health_and_Beauty_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
