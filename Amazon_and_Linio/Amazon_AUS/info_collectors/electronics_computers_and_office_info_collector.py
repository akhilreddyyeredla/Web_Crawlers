...
from product_parsers.electronics_computers_and_office_get_product_info import *
from Amazon_AUS import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Electronics_Computers_and_Office_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
