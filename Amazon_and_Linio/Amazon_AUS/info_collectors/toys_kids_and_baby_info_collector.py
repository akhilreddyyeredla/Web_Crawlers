...
from product_parsers.toys_kids_and_baby_get_product_info import *
...
def start_info_collection(folder_name):
    ...
    print 'Toys_Kids_and_Baby_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
