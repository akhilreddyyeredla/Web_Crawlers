...
def start_program():
    links = [
            'Sports_and_Outdoors|All_Sports_and_Outdoors|https://www.amazon.ca/sporting-goods/b/ref=sd_allcat_gno_sports_all/143-4227003-6144506?ie=UTF8&node=2242989011'
            ]
    for link in links:
