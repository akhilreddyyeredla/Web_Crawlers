...
DOMAIN_NAME = 'https://www.amazon.ca'

PROJECT_DOMAIN = 'www.amazon.ca'

MARKET_PLACE_NAME = 'AMAZON_CANADA'
...
# category_names
MUSIC = 'Music'
HOME_KITCHEN_AND_PETS = 'Home_Kitchen_and_Pets'
CLOTHING_SHOES_AND_JEWELRY = 'Clothing_Shoes_and_Jewelry'
SOFTWARE = 'Software'
HEALTH_BEAUTY_AND_GROCERY = 'Health_Beauty_and_Grocery'
BOOKS_AND_AUDIBLE = 'Books_and_Audible'
TOOLS_PATIO_AND_GARDEN = 'Tools_Patio_and_Garden'
TOYS_AND_BABY = 'Toys_and_Baby'
VIDEO_GAMES = 'Video_Games'
AUTOMOTIVE_AND_INDUSTRIAL = 'Automotive_and_Industrial'
