...
from product_parsers.coche_y_moto_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Coche_y_moto_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
