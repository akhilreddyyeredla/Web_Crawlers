...
from product_parsers.industria_empresas_y_ciencia_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Industria_empresas_y_ciencia_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
