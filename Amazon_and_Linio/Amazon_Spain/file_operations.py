...
def update_files(hierarchy_name, urls_list, page_url, queue_file_name, completed_file_name):
    queue_path = '{}{}{}{}{}{}{}'.format(DataCollectors_Configuration.ROOT_FOLDER, DataCollectors_Configuration.PATH_STYLE, DataCollectors_Configuration.AMAZON_AUS_PROJECT_NAME,
