...
DOMAIN_NAME = 'https://www.amazon.es'

PROJECT_DOMAIN = 'www.amazon.es'

MARKET_PLACE_NAME = 'AMAZON_ES'
...
# category_names
INFORMA_TICA_Y_OFICINA = 'Informa_tica_y_Oficina'
VIDEOJUEGOS = 'Videojuegos'
DEPORTES_Y_AIRE_LIBRE = 'Deportes_y_aire_libre'
ELECTRO_NICA = 'Electro_nica'
INDUSTRIA_EMPRESAS_Y_CIENCIA = 'Industria_empresas_y_ciencia'
COCHE_Y_MOTO = 'Coche_y_moto'
HOGAR_JARDI_N_BRICOLAJE_Y_MASCOTAS = 'Hogar_Jardi_n_Bricolaje_y_Mascotas'
ALIMENTACIO_N_Y_BEBIDAS = 'Alimentacio_n_y_bebidas'
JUGUETES_Y_BEBE_ = 'Juguetes_y_Bebe_'
LIBROS = 'Libros'
BELLEZA_Y_SALUD = 'Belleza_y_Salud'
CINE_TV_Y_MU_SICA = 'Cine_TV_y_Mu_sica'
HANDMADE = 'Handmade'
MODA = 'Moda'
