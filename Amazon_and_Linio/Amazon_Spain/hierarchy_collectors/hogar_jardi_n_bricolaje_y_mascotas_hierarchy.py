...
def start_program():
    links = [
        'Hogar_Jardi_n_Bricolaje_y_Mascotas|Jardi_n|https://www.amazon.es/b/ref=sd_allcat_gard/258-3512463-6364615?ie=UTF8&node=1354952031',
        'Hogar_Jardi_n_Bricolaje_y_Mascotas|Aspiracio_n_limpieza_y_planchado|https://www.amazon.es/aspiracion-limpieza-planchado/b/ref=sd_allcat_cle/258-3512463-6364615?ie=UTF8&node=2165650031',
        'Hogar_Jardi_n_Bricolaje_y_Mascotas|Todo_en_Bricolaje_y_herramientas|https://www.amazon.es/Bricolaje-Herramientas-Fontaneria-Ferreteria-Jardineria/b/ref=sd_allcat_all_tools/258-3512463-6364615?ie=UTF8&node=2454133031',
        'Hogar_Jardi_n_Bricolaje_y_Mascotas|Todo_en_Hogar_y_cocina|https://www.amazon.es/Hogar/b/ref=sd_allcat_allhk/258-3512463-6364615?ie=UTF8&node=599391031',
        'Hogar_Jardi_n_Bricolaje_y_Mascotas|Todo_para_mascotas|https://www.amazon.es/pet-supplies/b/ref=sd_allcat_pets/258-3512463-6364615?ie=UTF8&node=12472654031'
    ]

    nav_links = [
                'Hogar_Jardi_n_Bricolaje_y_Mascotas|Cocina_y_comedor|https://www.amazon.es/Cocina-Comedor/b/ref=sd_allcat_kidi/258-3512463-6364615?ie=UTF8&node=2181872031',
                'Hogar_Jardi_n_Bricolaje_y_Mascotas|Dormitorio_y_salo_n|https://www.amazon.es/Dormitorio-Salon/b/ref=sd_allcat_bedli/258-3512463-6364615?ie=UTF8&node=3365351031',
    ]
    for link in links:
    ...
    # for nav links call get nav hierarchy meathod it will find 1st level of hierarchy and adds links to the queue
    ...
    # wait until the links in url_queue are finished
    urls_queue.join()