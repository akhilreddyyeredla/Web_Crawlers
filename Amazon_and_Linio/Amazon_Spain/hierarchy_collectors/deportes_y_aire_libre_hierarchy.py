...
def start_program():
    links = [
        'Deportes_y_aire_libre|Todo_en_Deportes|https://www.amazon.es/deportes-aire-libre/b/ref=sd_allcat_all_sports/258-3512463-6364615?ie=UTF8&node=2454136031'
    ]
    for link in links:
    ...
    # wait till the links are finished in queue
    urls_queue.join()