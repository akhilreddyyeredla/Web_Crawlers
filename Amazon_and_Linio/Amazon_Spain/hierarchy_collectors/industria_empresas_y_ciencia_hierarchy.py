...
def start_program():
    links = [
        'Industria_empresas_y_ciencia|Todo_en_Industria_empresas_y_ciencia|https://www.amazon.es/industrial-cientfica/b/ref=sd_allcat_indus/258-3512463-6364615?ie=UTF8&node=5866088031'
    ]
    for link in links:
