...
def start_program():
    links = [
        'Belleza_y_Salud|Belleza|https://www.amazon.es/Categorias/b/ref=sd_allcat_sha/258-3512463-6364615?ie=UTF8&node=6198055031',
        'Belleza_y_Salud|Salud_y_cuidado_personal|https://www.amazon.es/Salud-y-cuidado-personal/b/ref=sd_allcat_sha/258-3512463-6364615?ie=UTF8&node=3677430031',
    ]
    for link in links:
