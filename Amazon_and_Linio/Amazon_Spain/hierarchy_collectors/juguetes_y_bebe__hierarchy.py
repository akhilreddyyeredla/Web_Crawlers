...
def start_program():
    links = [
        'Juguetes_y_Bebe_|Bebe_|https://www.amazon.es/bebe/b/ref=sd_allcat_baby/258-3512463-6364615?ie=UTF8&node=1703495031',
        'Juguetes_y_Bebe_|Juguetes_y_juegos|https://www.amazon.es/Juguetes-y-juegos/b/ref=sd_allcat_toy/258-3512463-6364615?ie=UTF8&node=599385031'
    ]
    for link in links:
