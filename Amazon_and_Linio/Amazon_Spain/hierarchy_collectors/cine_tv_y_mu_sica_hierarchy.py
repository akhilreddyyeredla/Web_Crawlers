...
def start_program():
    links = [
        'Cine_TV_y_Mu_sica|Todo_en_Cine_y_TV|https://www.amazon.es/Blu-ray-DVD-peliculas-series-3D/b/ref=sd_allcat_dvdtv/258-3512463-6364615?ie=UTF8&node=599379031',
        'Cine_TV_y_Mu_sica|CDs_y_vinilos|https://www.amazon.es/M%C3%BAsica/b/ref=sd_allcat_mu/258-3512463-6364615?ie=UTF8&node=599373031',

    ]
    acs_nav_links = [
        'Cine_TV_y_Mu_sica|Instrumentos_musicales|https://www.amazon.es/musical-instruments/b/ref=sd_allcat_ctm_mi/258-3512463-6364615?ie=UTF8&node=3628866031'
    ]
    for link in links:
    ...
    # for links in the acs nav links call find acs nav links then that method will find 1st level of hierarchy and adds to the queue
    for link in acs_nav_links:
        link_list = link.split('|')
        name = '|'.join(link_list[0:-1])
        url = link_list[-1]
        create_workers()
