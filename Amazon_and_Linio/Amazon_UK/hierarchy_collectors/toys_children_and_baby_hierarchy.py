...
def get_tree_hierarchy(hierarchy, url):
    ...
    :param url: current_page_url
    :return: None
    :working: this function will find out 1st level of hierarchy  and adds queue to the links 
    """
    response = get_content(url)
...
def start_program():
    links = [
            'Toys_Children_and_Baby|Baby|https://www.amazon.co.uk/Baby-Car-Seats-Prams-Nursery/b/ref=sd_allcat_ba/262-6468249-9592357?ie=UTF8&node=59624031',
            'Toys_Children_and_Baby|Toys_and_Games|https://www.amazon.co.uk/toys/b/ref=sd_allcat_tg/262-6468249-9592357?ie=UTF8&node=468292',
    ]
    for link in links:
