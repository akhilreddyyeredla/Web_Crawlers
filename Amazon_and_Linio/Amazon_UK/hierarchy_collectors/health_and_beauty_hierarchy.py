...
def start_program():
    links = [#'Health_and_Beauty|All_Beauty|https://www.amazon.co.uk/beauty-cosmetics/b/ref=sd_allcat_bty?ie=UTF8&node=117332031',
             #'Health_and_Beauty|Luxury_Beauty|https://www.amazon.co.uk/luxury-beauty/b/ref=sd_allcat_lux_bty?ie=UTF8&node=3411821031',
             # 'Health_and_Beauty|Health_and_Personal_Care|https://www.amazon.co.uk/health-beauty-haircare-wellbeing-dentalcare-shaving-hairremoval/b/ref=sd_allcat_hpc?ie=UTF8&node=65801031',
             'Health_and_Beauty|Men_s_Grooming|https://www.amazon.co.uk/male-grooming/b/ref=sd_allcat_men_grooming?ie=UTF8&node=3869264031'
         ]
