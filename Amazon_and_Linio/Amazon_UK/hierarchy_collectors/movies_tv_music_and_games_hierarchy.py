...
def get_tree_hierarchy(hierarchy, url):
    ...
    :param url: current_page_url
    :return: None
    :working: this function will find out 1st level of hierarchy  and add links to queue
    """
    response = get_content(url)
...
def start_program():
    links = [
       "Movies_TV_Music_and_Games|Musical_Instruments_and_DJ|https://www.amazon.co.uk/musical-instruments/b/ref=sd_allcat_mi/262-6468249-9592357?ie=UTF8&node=340837031",
       "Movies_TV_Music_and_Games|PC_and_Video_Games|https://www.amazon.co.uk/PC-Video-Games-Consoles-Accessories/b/ref=sd_allcat_cvg/262-6468249-9592357?ie=UTF8&node=300703",
        "Movies_TV_Music_and_Games|CDs_and_Vinyl|https://www.amazon.co.uk/music-rock-classical-pop-jazz/b/ref=sd_allcat_mu/262-6468249-9592357?ie=UTF8&node=229816"
    ]
    for link in links:
