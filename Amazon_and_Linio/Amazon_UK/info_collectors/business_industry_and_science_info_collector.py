...
from product_parsers.business_industry_and_science_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Business_Industry_and_Science_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
