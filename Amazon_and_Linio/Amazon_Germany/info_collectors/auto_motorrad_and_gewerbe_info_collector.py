...
from product_parsers.auto_motorrad_and_gewerbe_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Auto_Motorrad_and_Gewerbe_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
