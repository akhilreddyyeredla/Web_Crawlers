...
DOMAIN_NAME = 'https://www.amazon.de/'

PROJECT_DOMAIN = 'www.amazon.de'

MARKET_PLACE_NAME = 'AMAZON_GR'
...
# category_names
KLEIDUNG_SCHUHE_AND_UHREN = 'Kleidung_Schuhe_and_Uhren'
HAUSHALT_GARTEN_BAUMARKT = 'Haushalt_Garten_Baumarkt'
AUTO_MOTORRAD_AND_GEWERBE = 'Auto_Motorrad_and_Gewerbe'
HANDMADE_AND_AMAZON_LAUNCHPAD = 'Handmade_and_Amazon_Launchpad'
SPIELZEUG_AND_BABY = 'Spielzeug_and_Baby'
SPORT_AND_FREIZEIT = 'Sport_and_Freizeit'
FILME_SERIEN_MUSIK_AND_GAMES = 'Filme_Serien_Musik_and_Games'
ELEKTRONIK_AND_COMPUTER = 'Elektronik_and_Computer'
BEAUTY_DROGERIE_AND_LEBENSMITTEL = 'Beauty_Drogerie_and_Lebensmittel'
