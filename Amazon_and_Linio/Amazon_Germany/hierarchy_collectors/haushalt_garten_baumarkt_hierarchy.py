...
def start_program():
    indent_one_links = [
        'Haushalt_Garten_Baumarkt|Beleuchtung|https://www.amazon.de//Beleuchtung/b/ref=sd_allcat_light/257-0336225-6363765?ie=UTF8&node=213083031',
        'Haushalt_Garten_Baumarkt|Alles_in_Ku_che_Haushalt_and_Wohnen|https://www.amazon.de//k%C3%83%C2%BCche-haushalt-wohnen/b/ref=sd_allcat_allkhprod/257-0336225-6363765?ie=UTF8&node=3167641',
        'Haushalt_Garten_Baumarkt|Alles_in_Baumarkt|https://www.amazon.de//baumarkt-werkzeug-heimwerken/b/ref=sd_allcat_diy/257-0336225-6363765?ie=UTF8&node=80084031',
        'Haushalt_Garten_Baumarkt|Alle_Garten_Produkte|https://www.amazon.de//garten-shop/b/ref=sd_allcat_lg/257-0336225-6363765?ie=UTF8&node=10925031',
        'Haushalt_Garten_Baumarkt|Alles_fu_r_Tiere|https://www.amazon.de//Tierbedarf-Tiernahrung/b/ref=sd_allcat_ps/257-0336225-6363765?ie=UTF8&node=340852031'

    ]
    acs_links = [
                'Haushalt_Garten_Baumarkt|Werkzeuge_fu_r_Profis|https://www.amazon.de//professionelle-werkzeuge-f%C3%BCr-handwerker/b/ref=sd_allcat_profst/257-0336225-6363765?ie=UTF8&node=5490374031'
    ]
