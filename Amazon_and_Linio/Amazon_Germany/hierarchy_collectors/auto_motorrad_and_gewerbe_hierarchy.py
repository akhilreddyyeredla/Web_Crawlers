...
def start_program():
    links = [
        'Auto_Motorrad_and_Gewerbe|Alles_in_Gewerbe_Industrie_and_Wissenschaft|https://www.amazon.de//Gewerbe-Industrie-Wissenschaft/b/ref=sd_allcat_indus/257-0336225-6363765?ie=UTF8&node=5866098031'
    ]
    for link in links:
