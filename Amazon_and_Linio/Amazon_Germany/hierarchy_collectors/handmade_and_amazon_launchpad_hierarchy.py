...
def start_program():
    links = [
        'Handmade_and_Amazon_Launchpad|Alle_Handmade_Produkte|https://www.amazon.de//Handmade-Produkte/b/ref=sd_allcat_HM_Home/257-0336225-6363765?ie=UTF8&node=9699311031'
    ]
    for link in links:
