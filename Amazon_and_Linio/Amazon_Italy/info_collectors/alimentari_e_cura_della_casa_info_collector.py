...
from product_parsers.alimentari_e_cura_della_casa_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Alimentari_e_Cura_della_casa_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
