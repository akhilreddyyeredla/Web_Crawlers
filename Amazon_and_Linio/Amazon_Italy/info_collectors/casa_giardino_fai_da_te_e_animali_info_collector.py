...
from product_parsers.casa_giardino_fai_da_te_e_animali_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Casa_Giardino_Fai_da_te_e_Animali_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
