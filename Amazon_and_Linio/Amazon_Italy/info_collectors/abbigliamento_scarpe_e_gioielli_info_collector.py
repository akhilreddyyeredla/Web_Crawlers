...
from product_parsers.abbigliamento_scarpe_e_gioielli_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Abbigliamento_Scarpe_e_Gioielli_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
