...
def start_program():
    links = [
        'Alimentari_e_Cura_della_casa|Tutto_in_Alimentari_e_cura_della_casa|https://www.amazon.it/alimenti-bevande/b/ref=sd_allcat_allgrocery/259-2339394-2872550?ie=UTF8&node=6198092031'
    ]
    for link in links:
