...
def start_program():
    links = [
        'Sport_e_tempo_libero|Tutto_in_Sport_e_tempo_libero|https://www.amazon.it/Sports-and-Leisure/b/ref=sd_allcat_asport/259-2339394-2872550?ie=UTF8&node=524012031'
    ]
    for link in links:
