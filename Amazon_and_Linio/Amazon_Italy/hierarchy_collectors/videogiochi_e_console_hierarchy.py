...
def start_program():
    links = [
        'Videogiochi_e_Console|Tutto_in_Videogiochi_e_Console|https://www.amazon.it/videogiochi/b/ref=sd_allcat_vid_HPVG/259-2339394-2872550?ie=UTF8&node=412603031'
    ]
    for link in links:
