...
def start_program():
    links = [
        'Musique_DVD_et_Blu_ray|Toute_la_musique|https://www.amazon.fr/Musique-cd-disques-coffrets-classique-imports-doccasion/b/ref=sd_allcat_mu/259-8643187-8632807?ie=UTF8&node=301062',

    ]

    nav_links = [
        'Musique_DVD_et_Blu_ray|Instruments_de_musique_and_Sono|https://www.amazon.fr/Instruments-De-Musique-Sono/b/ref=sd_allcat_mi/259-8643187-8632807?ie=UTF8&node=340861031'
    ]
    for link in links:
