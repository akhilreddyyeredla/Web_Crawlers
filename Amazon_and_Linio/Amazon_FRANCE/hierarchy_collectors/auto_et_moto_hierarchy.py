...
def start_program():
    links = [
            'Auto_et_Moto|Pie_ces_et_accessoires_Auto|https://www.amazon.fr/Voiture-et-moto/b/ref=sd_allcat_auto_car_acc_parts/259-8643187-8632807?ie=UTF8&node=1571265031'
            ]
    for link in links:
