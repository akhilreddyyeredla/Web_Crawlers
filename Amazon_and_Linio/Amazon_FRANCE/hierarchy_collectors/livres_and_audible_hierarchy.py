...
def start_program():
    links = [
            'Livres_and_Audible|Tous_les_livres|https://www.amazon.fr/livre-achat-occasion-litterature-roman/b/ref=sd_allcat_lv/259-8643187-8632807?ie=UTF8&node=301061'
            ]
    for link in links:
