...
def start_program():
    links = [
            'Sports_et_Loisirs|Tous_les_Sports_et_Loisirs|https://www.amazon.fr/sports-loisirs-fitness/b/ref=sd_allcat_outdoorsports/259-8643187-8632807?ie=UTF8&node=325614031'
            ]
    for link in links:
