...
def start_program():
    links = [
            'Commerce_Industrie_et_Science|Tous_les_produits_Commerce_Industrie_et_Science|https://www.amazon.fr/Commerce-Industrie-Science/b/ref=sd_allcat_indus/259-8643187-8632807?ie=UTF8&node=5866109031'
            ]
    for link in links:
