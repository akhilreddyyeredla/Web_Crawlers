...
def start_program():
    links = [
        'High_Tech_et_Informatique|Tout_l_univers_High-Tech|https://www.amazon.fr/photo-TV-mp3-Hifi-GPS/b/ref=sd_allcat_el/259-8643187-8632807?ie=UTF8&node=13921051',
        'High_Tech_et_Informatique|Logiciels|https://www.amazon.fr/logiciels/b/ref=sd_allcat_log/259-8643187-8632807?ie=UTF8&node=530488',

    ]
    nav_links = [
        'High_Tech_et_Informatique|Tout_l_univers_Informatique|https://www.amazon.fr/informatique-ordinateurs-imprimantes-r%C3%A9seaux-composants/b/ref=sd_allcat_allpc/259-8643187-8632807?ie=UTF8&node=340858031'
    ]
    for link in links:
