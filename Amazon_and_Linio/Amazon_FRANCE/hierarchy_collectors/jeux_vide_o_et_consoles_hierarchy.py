...
def start_program():
    links = [
            'Jeux_vide_o_et_Consoles|Tous_les_jeux_vide_o|https://www.amazon.fr/jeux-video-consoles-portables-accessoires-pc/b/ref=sd_allcat_avg/259-8643187-8632807?ie=UTF8&node=530490'
            ]
    for link in links:
