...
from product_parsers.commerce_industrie_et_science_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Commerce_Industrie_et_Science_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
