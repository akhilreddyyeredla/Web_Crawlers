...
from product_parsers.ve_tements_chaussures_bijoux_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Ve_tements_Chaussures_Bijoux_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
