...
from product_parsers.jouets_enfants_et_be_be_s_get_product_info import *
import CONSTANTS
...
def start_info_collection(folder_name):
    ...
    print 'Jouets_Enfants_et_Be_be_s_info_collection|started-{}|ended-{}|total_time_taken-{} '.format(start_time, end_time, total_time)
