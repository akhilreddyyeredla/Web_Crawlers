...
'''
AMAZON_AUS_CATEGORY_LIST = ['Health_and_Beauty', 'Electronics_Computers_and_Office', 'Home_Improvement',
                 'Sports_Fitness_and_Outdoors', 'Books_and_Audible', 'Toys_Kids_and_Baby', 'Home_and_Kitchen', 'Fashion']
...
AMAZON_CANADA_CATEGORY_LIST = ['Music', 'Home_Kitchen_and_Pets', 'Clothing_Shoes_and_Jewelry', 'Software',
                 'Health_Beauty_and_Grocery', 'Books_and_Audible', 'Tools_Patio_and_Garden', 'Toys_and_Baby',
                 'Video_Games', 'Automotive_and_Industrial', 'Sports_and_Outdoors', 'Handmade',
                 'Electronics']
...
AMAZON_FRANCE_CATEGORY_LIST = ['Beaute__Sante__E_picerie', 'Jouets_Enfants_et_Be_be_s', 'Ve_tements_Chaussures_Bijoux',
                 'Maison_Bricolage_Animalerie', 'High_Tech_et_Informatique', 'Auto_et_Moto', 'Musique_DVD_et_Blu_ray',
                 'Livres_and_Audible', 'Jeux_vide_o_et_Consoles', 'Commerce_Industrie_et_Science', 'Sports_et_Loisirs',
                 'Handmade']
###
...
AMAZON_GERMANY_CATEGORY_LIST = [ 'Kleidung_Schuhe_and_Uhren', 'Haushalt_Garten_Baumarkt',
                 'Auto_Motorrad_and_Gewerbe', 'Handmade_and_Amazon_Launchpad', 'Spielzeug_and_Baby',
                 'Sport_and_Freizeit', 'Filme_Serien_Musik_and_Games', 'Elektronik_and_Computer',
                 'Beauty_Drogerie_and_Lebensmittel']
...
AMAZON_ITALY_CATEGORY_LIST = ['Musica_Film_e_TV', 'Videogiochi_e_Console', 'Alimentari_e_Cura_della_casa',
                 'Elettronica_e_Informatica', 'Commercio_Industria_e_Scienza', 'Sport_e_tempo_libero',
                 'Libri_e_Audible', 'Casa_Giardino_Fai_da_te_e_Animali', 'Giochi_e_Prima_infanzia',
                 'Bellezza_e_Salute', 'Abbigliamento_Scarpe_e_Gioielli', 'Auto_e_Moto',
                 'Handmade']
...
AMAZON_MEXICO_CATEGORY_LIST =  ['Automotriz_y_Motocicletas', 'Bebe_', 'Co_mputo_y_Tablets', 'Deportes_y_Aire_Libre', 'Electro_nicos',
                 'Handmade', '', 'Hogar_y_Cocina', 'Industria_Empresas_y_Ciencia',
                 'Juegos_y_Juguetes', 'Libros', 'Mascotas_y_Accesorios', 'Peli_culas_Series_de_TV_y_Mu_sica',
                 'Ropa_Zapatos_y_Accesorios', 'Salud_Belleza_y_Cuidado_Personal', 'Software', 'Videojuegos']
...
'''
'''
AMAZON_SPAIN_CATEGORY_LIST = ['Informa_tica_y_Oficina', 'Videojuegos', 'Deportes_y_aire_libre', 'Electro_nica', 'Industria_empresas_y_ciencia', 'Coche_y_moto', 'Hogar_Jardi_n_Bricolaje_y_Mascotas', 'Alimentacio_n_y_bebidas', 'Juguetes_y_Bebe_', 'Libros', 'Belleza_y_Salud', 'Cine_TV_y_Mu_sica', 'Handmade', 'Moda']
'''

AMAZON_SPAIN_CATEGORY_LIST = ['Electro_nica', 'Industria_empresas_y_ciencia', 'Coche_y_moto', 'Hogar_Jardi_n_Bricolaje_y_Mascotas', 'Alimentacio_n_y_bebidas', 'Juguetes_y_Bebe_', 'Libros', 'Belleza_y_Salud', 'Cine_TV_y_Mu_sica', 'Handmade', 'Moda']
...
AMAZON_UK_CATEGORY_LIST = ['Amazon_Pantry', 'Books_and_Audible', 'Business_Industry_and_Science', 'Car_and_Motorbike',
                 'Clothes_Shoes_and_Watches', 'Electronics_and_Computers', 'Handmade', 'Health_and_Beauty',
                 'Home_Garden_Pets_and_DIY', 'Movies_TV_Music_and_Games', 'Sports_and_Outdoors', 'Toys_Children_and_Baby']
...
AMAZON_US_CATEGORY_LIST = ['International_Shopping', 'books', 'home_garden_and_tools', 'beauty_and_health', 
                'toys_and_games', 'sports_and_outdoor', 'clothing', 'Electronics_Computers_and_Office', 'handmade']
...
SOUQ_CATEGORY_LIST = ['Beauty','Baby', 'Bed_and_Bath','Books', 'Apparel_Shoes_and_Accessories','Art_Crafts_and_Collectibles','Electronics'
...
EBAY_CATEGORY_LIST = ['Motors', 'Fashion', 'Electronics', 'Collectibles_AND_Art', 'Home_AND_Garden', 'Sporting_Goods', 'Toys_AND_Hobbies', 'Business_AND_Industrial', 'Music' ];
...
# POSSIBLE VALUES: belleza , celulares , computacion , consolas , deportes , electrodomesticos , hogar , juguetes ,
# moda , salud , tv CATEGORIES = [ 'belleza', 'celulares', 'computacion', 'consolas' , 'deportes' ,
# 'electrodomesticos', 'hogar' , 'juguetes' , 'moda' , 'salud' , 'tv']
LINIO_MEX_CATEGORIES = [ 'belleza', 'celulares', 'computacion', 'consolas' , 'deportes' ,'electrodomesticos', 'hogar' , 'juguetes' , 'moda' , 'salud' , 'tv']
