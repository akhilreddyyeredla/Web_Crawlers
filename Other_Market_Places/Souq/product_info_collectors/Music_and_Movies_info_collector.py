...
class Workers:
    ...
    def work(self):
        while True:
            ...
            info_completed_path = DataCollectors_Configuration.SOUQ_INFO_ROOT_FOLDER + DataCollectors_Configuration.PATH_STYLE + hierarchy.replace(
                '|', '/') + '/' + DataCollectors_Configuration.MUSIC_AND_MOVIES
    ...
    def save_data(self, thread_name, hierarchy, url):
        ...
        if raw_data:
            ...
            data_obj = Music_and_Movies_ProductDetails()
    ...
    def get_page_data(self):
        ...
        path = '{}{}{}'.format(DataCollectors_Configuration.SOUQ_URL_ROOT_FOLDER,
                               DataCollectors_Configuration.PATH_STYLE, DataCollectors_Configuration.MUSIC_AND_MOVIES)
...
def start_info_collection():
    print('starting Music_and_Movies information collection')
    starting_time = time.time()
    obj_info = Workers()
    obj_info.get_page_data()
    ending_time = time.time()
    total_time = ending_time - starting_time
    print('Music_and_Movies_info_collection:' + "|" + "Start Time:" + str(
