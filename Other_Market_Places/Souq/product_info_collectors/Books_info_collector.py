...
class Workers:
    ...
    def work(self):
        while True:
            ...
            info_completed_path = DataCollectors_Configuration.SOUQ_INFO_ROOT_FOLDER + DataCollectors_Configuration.PATH_STYLE + hierarchy.replace(
                '|', '/') + '/' + DataCollectors_Configuration.BOOKS
    ...
    def get_page_data(self):
        ...
        path = '{}{}{}'.format(DataCollectors_Configuration.SOUQ_URL_ROOT_FOLDER,
                               DataCollectors_Configuration.PATH_STYLE, DataCollectors_Configuration.BOOKS)
...
def start_info_collection():
    print('starting Books information collection')
    starting_time = time.time()
    obj_info = Workers()
    obj_info.get_page_data()
    ending_time = time.time()
    total_time = ending_time - starting_time
    print('Books_info_collection:' + "|" + "Start Time:" + str(
