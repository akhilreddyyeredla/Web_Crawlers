...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Books_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Books_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Books_SKIPPED_FILE
#
...
class Workers():
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Books urls collected in :' + "|" + "Start Time:" + str(
