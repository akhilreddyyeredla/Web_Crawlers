...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Computers_IT_and_Networking_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Computers_IT_and_Networking_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Computers_IT_and_Networking_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Computers_IT_and_Networking urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Computers_IT_and_Networking urls collected in :' + "|" + "Start Time:" + str(
