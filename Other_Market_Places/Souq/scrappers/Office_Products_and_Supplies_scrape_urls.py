...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Office_Products_and_Supplies_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Office_Products_and_Supplies_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Office_Products_and_Supplies_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Office_Products_and_Supplies urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Office_Products_and_Supplies urls collected in :' + "|" + "Start Time:" + str(
