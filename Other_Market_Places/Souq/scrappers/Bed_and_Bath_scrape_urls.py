...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Bed_and_Bath_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Bed_and_Bath_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Bed_and_Bath_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Bed_and_Bath urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Bed_and_Bath urls collected in :' + "|" + "Start Time:" + str(
