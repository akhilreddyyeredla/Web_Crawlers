...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Perfumes_and_Fragrances_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Perfumes_and_Fragrances_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Perfumes_and_Fragrances_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Perfumes_and_Fragrances urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Perfumes_and_Fragrances urls collected in :' + "|" + "Start Time:" + str(
