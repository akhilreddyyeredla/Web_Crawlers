...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Vouchers_and_Tickets_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Vouchers_and_Tickets_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Vouchers_and_Tickets_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Vouchers_and_Tickets urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Vouchers_and_Tickets urls collected in :' + "|" + "Start Time:" + str(
