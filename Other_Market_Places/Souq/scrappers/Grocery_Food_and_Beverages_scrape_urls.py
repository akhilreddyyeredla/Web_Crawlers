...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Grocery_Food_and_Beverages_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Grocery_Food_and_Beverages_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Grocery_Food_and_Beverages_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Grocery_Food_and_Beverages urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Grocery_Food_and_Beverages urls collected in :' + "|" + "Start Time:" + str(
