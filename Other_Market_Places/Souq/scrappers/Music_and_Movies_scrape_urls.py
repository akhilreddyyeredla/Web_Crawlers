...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Music_and_Movies_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Music_and_Movies_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Music_and_Movies_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Music_and_Movies urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Music_and_Movies urls collected in :' + "|" + "Start Time:" + str(
