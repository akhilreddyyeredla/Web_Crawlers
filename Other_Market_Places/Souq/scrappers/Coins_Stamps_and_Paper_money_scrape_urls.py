...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Coins_Stamps_and_Paper_money_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Coins_Stamps_and_Paper_money_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Coins_Stamps_and_Paper_money_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Coins_Stamps_and_Paper_money urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Coins_Stamps_and_Paper_money urls collected in :' + "|" + "Start Time:" + str(
