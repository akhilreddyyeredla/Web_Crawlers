...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Kitchen_Appliances_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Kitchen_Appliances_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Kitchen_Appliances_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Kitchen_Appliances urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Kitchen_Appliances urls collected in :' + "|" + "Start Time:" + str(
