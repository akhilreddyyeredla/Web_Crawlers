...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Tools_and_Home_Improvements_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Tools_and_Home_Improvements_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Tools_and_Home_Improvements_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Tools_and_Home_Improvements urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Tools_and_Home_Improvements urls collected in :' + "|" + "Start Time:" + str(
