...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Sports_and_Fitness_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Sports_and_Fitness_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Sports_and_Fitness_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Sports_and_Fitness urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Sports_and_Fitness urls collected in :' + "|" + "Start Time:" + str(
