...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Health_and_Personal_Care_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Health_and_Personal_Care_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Health_and_Personal_Care_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Health_and_Personal_Care urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Health_and_Personal_Care urls collected in :' + "|" + "Start Time:" + str(
