...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Baby_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Baby_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Baby_SKIPPED_FILE
#
...
class Workers():
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Baby urls collected in :' + "|" + "Start Time:" + str(
