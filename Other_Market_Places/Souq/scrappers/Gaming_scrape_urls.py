...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Gaming_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Gaming_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Gaming_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Gaming urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Gaming urls collected in :' + "|" + "Start Time:" + str(
