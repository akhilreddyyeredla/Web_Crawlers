...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Art_Crafts_and_Collectibles_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Art_Crafts_and_Collectibles_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Art_Crafts_and_Collectibles_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Art_Crafts_and_Collectibles urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Art_Crafts_and_Collectibles urls collected in :' + "|" + "Start Time:" + str(
