...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Home_Decor_and_Furniture_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Home_Decor_and_Furniture_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Home_Decor_and_Furniture_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Home_Decor_and_Furniture urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Home_Decor_and_Furniture urls collected in :' + "|" + "Start Time:" + str(
