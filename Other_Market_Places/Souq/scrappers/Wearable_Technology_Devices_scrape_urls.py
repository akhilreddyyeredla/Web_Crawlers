...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Wearable_Technology_Devices_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Wearable_Technology_Devices_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Wearable_Technology_Devices_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Wearable_Technology_Devices urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Wearable_Technology_Devices urls collected in :' + "|" + "Start Time:" + str(
