...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Eyewear_and_Optics_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Eyewear_and_Optics_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Eyewear_and_Optics_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Eyewear_and_Optics urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Eyewear_and_Optics urls collected in :' + "|" + "Start Time:" + str(
