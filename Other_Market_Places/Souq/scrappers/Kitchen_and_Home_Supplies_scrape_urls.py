...
#
#         # To store File paths
#         self.queue_file = Souq.path_CONSTANTS.Kitchen_and_Home_Supplies_QUEUE_FILE
#         self.completed_file = Souq.path_CONSTANTS.Kitchen_and_Home_Supplies_COMPLETED_FILE
#         self.skipped_file = Souq.path_CONSTANTS.Kitchen_and_Home_Supplies_SKIPPED_FILE
#
...
class Workers():
    ...
    def __init__(self):
        ...
        print("started Kitchen_and_Home_Supplies urls collection")
        self.create_workers()
        self.crawl()
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Kitchen_and_Home_Supplies urls collected in :' + "|" + "Start Time:" + str(
