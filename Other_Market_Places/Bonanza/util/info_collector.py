...
class Workers:
    ...
    def __init__(self, ):
        ...
        self.ending_time = 0
        print('starting ANTIQUES information collection')
    ...
    def crawl(self, urls_list):
        ...
        if len(queued_links) > 0:
            ...
            print("Antiques_info_completed" + "|" + "Start Time:" + str(self.starting_time) + "|" + "End Time:" + str(
    ...
    def save_data(self, thread_name, hierarchy, url):
        ...
        if raw_data:
            ...
            data = self.get_details(raw_data, hierarchy, url)
            ...
            append_to_file(completed_path,
                           '{}|{}|{}|{}|{}'.format(market_place, Domain_name, hierarchy, hierarchy_length, url))
