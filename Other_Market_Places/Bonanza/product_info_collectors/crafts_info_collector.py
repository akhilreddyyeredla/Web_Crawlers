...
class Workers:
    ...
    def __init__(self, ):
        ...
        self.ending_time = 0
        print('starting CRAFTS information collection')
    ...
    def crawl(self, urls_list):
        ...
        if len(queued_links) > 0:
            ...
            print("CRAFTS_info_completed" + "|" + "Start Time:" + str(self.starting_time) + "|" + "End Time:" + str(
    ...
    def save_data(self, thread_name, hierarchy, url):
        ...
        if raw_data:
            ...
            obj = crafts_parser_collector.ProductDetails()
