...
queue_file = '{}/{}/Pottery_and_Glass/Pottery_and_Glass_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Pottery_and_Glass/Pottery_and_Glass_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started POTTERY urls collection")
    ...
    print("Pottery_and_Glass urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
