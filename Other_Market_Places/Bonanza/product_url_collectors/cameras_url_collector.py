...
queue_file = '{}/{}/Cameras_and_Photo/Cameras_and_Photo_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Cameras_and_Photo/Cameras_and_Photo_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started CAMERAS urls collection")
    ...
    print("Cameras_and_Photo urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
