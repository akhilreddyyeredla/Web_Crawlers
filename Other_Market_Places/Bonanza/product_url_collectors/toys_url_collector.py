...
queue_file = '{}/{}/Toys_and_Hobbies/Toys_and_Hobbies_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Toys_and_Hobbies/Toys_and_Hobbies_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started TOYS urls collection")
    ...
    print("Toys & Hobbies" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
