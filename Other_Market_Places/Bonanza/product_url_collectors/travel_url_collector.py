...
queue_file = '{}/{}/Travel/Travel_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Travel/Travel_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started TRAVEL urls collection")
    ...
    print("Travel urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
