...
queue_file = '{}/{}/Tickets_and_Experiences/Tickets_and_Experiences_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Tickets_and_Experiences/Tickets_and_Experiences_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started TICKETS urls collection")
    ...
    print("Tickets_and_Experiences urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
