...
queue_file = '{}/{}/Sports_Mem__Cards_and_Fan_Shop/Sports_Mem__Cards_and_Fan_Shop_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Sports_Mem__Cards_and_Fan_Shop/Sports_Mem__Cards_and_Fan_Shop_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started SPORTS_MEM urls collection")
    ...
    print("Sports_Mem__Cards_and_Fan_Shop urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
