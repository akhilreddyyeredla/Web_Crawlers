...
queue_file = '{}/{}/Everything_Else/Everything_Else_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Everything_Else/Everything_Else_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started EVERYTHING_ELSE urls collection")
    ...
    print("Everything Else urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
