...
queue_file = '{}/{}/Home_and_Garden/Home_and_Garden_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Home_and_Garden/Home_and_Garden_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started HOME_GARDEN urls collection")
    ...
    print("Home_and_Garden urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
