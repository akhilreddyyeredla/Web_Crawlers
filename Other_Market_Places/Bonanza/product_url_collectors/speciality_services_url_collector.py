...
queue_file = '{}/{}/Specialty_Services/Specialty_Services_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Specialty_Services/Specialty_Services_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started SPECIALITY_SERVICES urls collection")
    ...
    print("Specialty_Services urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
