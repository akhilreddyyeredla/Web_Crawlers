...
queue_file = '{}/{}/Health_and_Beauty/Health_and_Beauty_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Health_and_Beauty/Health_and_Beauty_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started HEALTH_BEAUTY urls collection")
    ...
    print("Health_and_Beauty urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
