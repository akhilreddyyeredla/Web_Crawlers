...
queue_file = '{}/{}/Musical_Instruments_and_Gear/Musical_Instruments_and_Gear_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Musical_Instruments_and_Gear/Musical_Instruments_and_Gear_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started MUSICAL_INSTRUMENTS urls collection")
    ...
    print("Musical_Instruments_and_Gear urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
