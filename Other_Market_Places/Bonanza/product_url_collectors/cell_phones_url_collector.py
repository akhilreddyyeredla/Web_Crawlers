...
queue_file = '{}/{}/Cell_Phones_and_Accessories/Cell_Phones_and_Accessories_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Cell_Phones_and_Accessories/Cell_Phones_and_Accessories_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started CELL_PHONES urls collection")
    ...
    print("Cell_Phones_and_Accessories urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
