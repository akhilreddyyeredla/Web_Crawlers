...
queue_file = '{}/{}/Collectibles/Collectibles_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Collectibles/Collectibles_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started COLLECTIBLES urls collection")
    ...
    print("Collectibles urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
