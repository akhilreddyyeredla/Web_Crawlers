...
queue_file = '{}/{}/DVDs_and_Movies/DVDs_and_Movies_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/DVDs_and_Movies/DVDs_and_Movies_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started DVDS_MOVIES urls collection")
    ...
    print("DVDs_and_Movies urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
