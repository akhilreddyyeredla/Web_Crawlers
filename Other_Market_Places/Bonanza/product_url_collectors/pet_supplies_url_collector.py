...
queue_file = '{}/{}/Pet_Supplies/Pet_Supplies_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Pet_Supplies/Pet_Supplies_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started PET_SUPPLIES urls collection")
    ...
    print("Pet_Supplies urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
