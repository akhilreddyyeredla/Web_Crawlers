...
queue_file = '{}/{}/Fashion/Fashion_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Fashion/Fashion_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started FASHION urls collection")
    ...
    print("Fashion urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
