...
queue_file = '{}/{}/Video_Games_and_Consoles/Video_Games_and_Consoles_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Video_Games_and_Consoles/Video_Games_and_Consoles_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started VIDEO_GAMES urls collection")
    ...
    print("Video_Games_and_Consoles urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
