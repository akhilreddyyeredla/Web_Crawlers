...
queue_file = '{}/{}/Dolls_and_Bears/Dolls_and_Bears_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Dolls_and_Bears/Dolls_and_Bears_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started DOLLS urls collection")
    ...
    print("Dolls_and_Bears urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
