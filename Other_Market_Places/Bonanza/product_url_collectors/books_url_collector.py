...
queue_file = '{}/{}/Books/Books_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Books/Books_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started BOOKS urls collection")
    ...
    print("Books urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
