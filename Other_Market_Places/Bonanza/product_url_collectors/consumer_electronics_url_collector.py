...
queue_file = '{}/{}/Consumer_Electronics/Consumer_Electronics_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Consumer_Electronics/Consumer_Electronics_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started CONSUMER_ELECTRONICS urls collection")
    ...
    print("Consumer_Electronics urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
