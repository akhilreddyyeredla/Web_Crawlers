...
queue_file = '{}/{}/Baby/Baby_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Baby/Baby_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started BABY urls collection")
    ...
    print("Baby urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
