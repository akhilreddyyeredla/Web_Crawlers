...
queue_file = '{}/{}/Coins_and_Paper_Money/Coins_and_Paper_Money_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Coins_and_Paper_Money/Coins_and_Paper_Money_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started COINS urls collection")
    ...
    print("Coins_and_Paper_Money urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
