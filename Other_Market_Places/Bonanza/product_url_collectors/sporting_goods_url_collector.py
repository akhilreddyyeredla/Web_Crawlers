...
queue_file = '{}/{}/Sporting_Goods/Sporting_Goods_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Sporting_Goods/Sporting_Goods_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started SPORTING_GOODS urls collection")
    ...
    print("Sporting_Goods urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
