...
queue_file = '{}/{}/Crafts/Crafts_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Crafts/Crafts_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started CRAFTS urls collection")
    ...
    print("Crafts urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
