...
queue_file = '{}/{}/Entertainment_Memorabilia/Entertainment_Memorabilia_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Entertainment_Memorabilia/Entertainment_Memorabilia_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started ENTERTAINMENT urls collection")
    ...
    print("Entertainment_Memorabilia urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
