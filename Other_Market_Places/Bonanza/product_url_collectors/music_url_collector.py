...
queue_file = '{}/{}/Music/Music_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Music/Music_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started MUSIC urls collection")
    ...
    print("Music urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
