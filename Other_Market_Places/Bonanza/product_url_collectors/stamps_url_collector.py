...
queue_file = '{}/{}/Stamps/Stamps_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Stamps/Stamps_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started STAMPS urls collection")
