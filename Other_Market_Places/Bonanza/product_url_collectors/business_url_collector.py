...
queue_file = '{}/{}/Business_and_Industrial/Business_and_Industrial_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Business_and_Industrial/Business_and_Industrial_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started BUSINESS urls collection")
    ...
    print("Business_and_Industrial urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
