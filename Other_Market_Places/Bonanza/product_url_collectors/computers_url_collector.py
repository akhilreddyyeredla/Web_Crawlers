...
queue_file = '{}/{}/Computers_Tablets_and_Networking/Computers_Tablets_and_Networking_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
...
def start_url_collection():
    ...
    print("started COMPUTERS urls collection")
    ...
    print("Computers_Tablets_and_Networking urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
