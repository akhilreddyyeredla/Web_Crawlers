...
queue_file = '{}/{}/Jewelry_and_Watches/Jewelry_and_Watches_link_queue.txt'.format(DataCollectors_Configuration.ROOT_FOLDER_BONANZA_HIERARCHY,
                                                             project_name)
completed_file = '{}/{}/Jewelry_and_Watches/Jewelry_and_Watches_link_completed.txt'.format(
...
def start_url_collection():
    ...
    print("started JEWELLERY urls collection")
    ...
    print("ANTIQUES urls" + "|" + "Start Time:" + str(starting_time) + "|" + "End Time:" + str(
