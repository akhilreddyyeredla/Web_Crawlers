...
ROOT_FOLDER = DataCollectors_Configuration.ETSY_HIERARCHY_ROOT_FOLDER
...
def files_path(name):
    ...
    :return: project_name , category_queue_file path name, sub_category_queue path, sub_sub_category_queue path and
            category_name
    """
    category_queue = ROOT_FOLDER + PATH_STYLE + name + DataCollectors_Configuration.CATEGORY_QUEUE.format(name)
    sub_category_queue = ROOT_FOLDER + PATH_STYLE + name + DataCollectors_Configuration.SUB_CATEGORY_QUEUE.format(name)
    sub_sub_category_queue = ROOT_FOLDER + PATH_STYLE + name + DataCollectors_Configuration.SUB_SUB_CATEGORY_QUEUE.format(
        name)
    return ROOT_FOLDER + PATH_STYLE + name, category_queue, sub_category_queue, sub_sub_category_queue, name
