...
class Workers:
    ...
    starting_time = 0
    ending_time = 0
    products_page_url_queue_file = path_CONSTANTS.ART_AND_COLLECTIBLES_QUEUE_PATH
    products_page_url_completed_file = path_CONSTANTS.ART_AND_COLLECTIBLES_COMPLETED_PATH
    products_page_url_skipped_file = path_CONSTANTS.ART_AND_COLLECTIBLES_SKIPPED_PATH
    ...
    def __init__(self):
        print("starting ART_AND_COLLECTIBLES product url collection")
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Total_time taken to collect ART_AND_COLLECTIBLES category urls: ' + "|Start Time:"+str(self.starting_time)+"| End Time:"+str(self.ending_time)+"|Total Time:"+str(total_time) + 'sec')
