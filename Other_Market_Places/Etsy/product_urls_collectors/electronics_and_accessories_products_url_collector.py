...
class Workers:
    ...
    starting_time = 0
    ending_time = 0
    products_page_url_queue_file = path_CONSTANTS.ELECTRONICS_AND_ACCESSORIES_QUEUE_PATH
    products_page_url_completed_file = path_CONSTANTS.ELECTRONICS_AND_ACCESSORIES_COMPLETED_PATH
    products_page_url_skipped_file = path_CONSTANTS.ELECTRONICS_AND_ACCESSORIES_SKIPPED_PATH
    ...
    def __init__(self):
        print("starting ELECTRONICS_AND_ACCESSORIES product url collection")
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Total_time taken to collect ELECTRONICS_AND_ACCESSORIES category urls: ' + "|Start Time:"+str(self.starting_time)+"| End Time:"+str(self.ending_time)+"|Total Time:"+str(total_time) + 'sec')
