...
class Workers:
    ...
    starting_time = 0
    ending_time = 0
    products_page_url_queue_file = path_CONSTANTS.HOME_AND_LIVING_QUEUE_PATH
    products_page_url_completed_file = path_CONSTANTS.HOME_AND_LIVING_COMPLETED_PATH
    products_page_url_skipped_file = path_CONSTANTS.HOME_AND_LIVING_SKIPPED_PATH
    ...
    def __init__(self):
        print("starting HOME_AND_LIVING product url collection")
    ...
    def crawl(self):
        ...
        if len(queued_links) > 0:
            ...
            print('Total_time taken to collect HOME_AND_LIVING category urls: ' + "|Start Time:"+str(self.starting_time)+"| End Time:"+str(self.ending_time)+"|Total Time:"+str(total_time) + 'sec')
